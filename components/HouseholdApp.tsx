...
import { FiClipboard, FiCreditCard, FiDollarSign, FiLogOut, FiMenu, FiSettings, FiShoppingCart, FiTrendingUp, FiX } from "react-icons/fi";
...
type AppSection = "shopping" | "expenses" | "expense-report" | "forecast" | "admin" | "loans" | "improvement-log";
...
export default function HouseholdApp() {
  ...
  return (
    <CategoryConfigProvider>
      {section !== "admin" && section !== "expense-report" && section !== "loans" && section !== "improvement-log" && <div className="mx-auto w-full max-w-md px-4 pt-4 sm:px-5 sm:pt-5">
      ...
      {section !== "admin" && section !== "loans" && section !== "improvement-log" && <nav
