...
export function useForecast() {
  ...
  return { schedules, oneOffs, months, overrides, occurrenceOverrides, audit: [...audit].sort((a,b) => b.createdAtMs-a.createdAtMs), expenses: expensesState.expenses, loans: personalLoansState.loans, loanRepayments: personalLoansState.repayments, loading: expensesState.loading || personalLoansState.loading, error: error ?? expensesState.error ?? personalLoansState.error };
}
